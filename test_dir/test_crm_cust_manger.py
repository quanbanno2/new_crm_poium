...
def add_new_order(driver, url, login_name, password, consultant, course_name, school_name):
    """
    客户创建订单
    :param driver:
    :param url:
...
class TestCustomerAdd:
    ...
    def test_add_customer(self, crm_url, browser1, new_student_name, phone_number, pass_word, counseling_supervision,
                          school_name):
        """
        测试新增客户：新招生
        :param crm_url:
...
class TestCustomerAddOrder:
    ...
    def test_add_new_order(self, crm_url, browser1, adviser_name, course, pass_word, supervisor_account, school_name):
        """
        测试创建订单-新单招生
        :param crm_url:
        :param browser1:
